...
-- Check new columns in user_submissions
...
SELECT * FROM get_broker_performance();
...
DO $$
BEGIN
  RAISE NOTICE 'Click tracking migration completed successfully!';
  RAISE NOTICE 'Tables created: broker_clicks';
  RAISE NOTICE 'Columns added to user_submissions: has_account, broker_info, user_type, etc.';
  RAISE NOTICE 'Function created: get_broker_performance()';
END $$;
